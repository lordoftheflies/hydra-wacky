...
public class RealTimeWebSocketServerMsgHandler {

    private static Logger LOG = LoggerFactory.getLogger(RealTimeWebSocketServerMsgHandler.class);
    ...
    public RealTimeWebSocketServerMsgHandler() {
        BundleContext context = FrameworkUtil.getBundle(RealTimeWebSocketServerMsgHandler.class).getBundleContext();
