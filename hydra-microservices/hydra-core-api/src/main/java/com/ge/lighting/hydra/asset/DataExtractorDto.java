...
//        this.init();
    ...
    public DataExtractorDto(UUID id, UUID classId, double lon, double lat, double alt) {
        this.sensors = new ArrayList<>();
...
//    }
    ...
    private UUID classification;

    public UUID getClassification() {
        return classification;
    }

    public void setClassification(UUID classification) {
