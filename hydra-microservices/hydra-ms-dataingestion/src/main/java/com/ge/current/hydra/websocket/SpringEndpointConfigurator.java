 ...
 */
public class SpringEndpointConfigurator extends SpringConfigurator implements ServletContextAware {

    private static final String NO_VALUE = ObjectUtils.identityToString(new Object());

    private static final Log logger = LogFactory.getLog(SpringEndpointConfigurator.class);
...
//    }
    ...
    public void setServletContext(ServletContext servletContext) {
        wac = WebApplicationContextUtils.findWebApplicationContext(servletContext);
    }
}
