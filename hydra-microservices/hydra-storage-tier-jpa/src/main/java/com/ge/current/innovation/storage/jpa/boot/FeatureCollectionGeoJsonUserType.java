 ...
 */
public class FeatureCollectionGeoJsonUserType implements UserType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        try {
            return objectMapper.readValue(rs.getString(names[0]), FeatureCollection.class);
        } catch (IOException ex) {
            throw new HibernateException("Could not deserialize json " + rs.getString(names[0]), ex);
        }
    }
