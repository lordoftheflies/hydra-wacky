...
@ComponentScan
@Profile("local")
public class RabbitConfigurationLocal implements RabbitListenerConfigurer {

	static final String DEMONSTRATION_ADDRESS = "3.117.211.148";
...
//        factory.setConcurrentConsumers();
    ...
    public ConnectionFactory connectionFactory() {
        ...
        connectionFactory.setHost(DEMONSTRATION_ADDRESS);
