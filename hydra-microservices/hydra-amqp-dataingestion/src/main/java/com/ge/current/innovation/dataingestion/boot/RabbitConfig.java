...
@Configuration
@ComponentScan
public class RabbitConfig extends AbstractCloudConfig implements RabbitListenerConfigurer {
...
//        MessageListenerAdapter adapter = new MessageListenerAdapter(new DataIngestionListener(dataPointRepository, assetMeterRepository), "onMessage");
        MessageListenerAdapter adapter = new MessageListenerAdapter(new DataIngestionListener(), "onMessage");
