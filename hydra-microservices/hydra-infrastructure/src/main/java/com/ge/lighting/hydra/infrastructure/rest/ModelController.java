...
import com.ge.lighting.hydra.infrastructure.dto.AttributeDto;
import com.ge.lighting.hydra.infrastructure.dto.ClassificationDto;
...
public class ModelController {
    ...
    public ClassificationDto classification(@PathVariable("id") String id) {
        MetaEntity cf = modelStore.getMetaEntityDao().findOne(UUID.fromString(id));
